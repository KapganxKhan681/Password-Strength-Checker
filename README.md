...
# 🔐 Parola Gücü Kontrol Programı (Password Strength Checker)

### 🇹🇷 Açıklama
Standart kriptografik kılavuzlara (NIST) uygun olarak parola gücünü değerlendirmek için tasarlanmış Python tabanlı bir güvenlik otomasyon aracıdır. Uygulama; kesintisiz bir kullanıcı deneyimi sunmak adına sağlam girdi doğrulama, string manipülasyonu ile karakter analizi ve döngü yapıları içerir.
